...
var MouseTimeDisplay = (function (_Component) {
  ...
  MouseTimeDisplay.prototype.update = function update(newTime, position) {
    ...
    var frame_rate = this.options_['frame_rate'] || this.options_.playerOptions && this.options_.playerOptions['frame_rate'];
    var time = secFrameToTimecode (newTime, frame_rate);
...
var SeekBar = (function (_Slider) {
  ...
  SeekBar.prototype.handleMouseMove = function handleMouseMove(event) {
    //console.log("this.player_ ::",this.player_.bigPlayButton);
    this.player_.bigPlayButton.addClass('vjs-hidden');
  ...
  SeekBar.prototype.handleMouseUp = function handleMouseUp(event) {
    ...
    if (this.videoWasPlaying) {
      ...
      this.player_.bigPlayButton.removeClass('vjs-hidden');
    }
  };
...
var CurrentTimeDisplay = (function (_Component) {
  ...
  CurrentTimeDisplay.prototype.createEl = function createEl() {
    ...
    this.contentEl_ = Dom.createEl('div', {
      ...
      innerHTML: '<span class="vjs-control-text">Current Time </span>' + '00:00:00:00'
    }, {
  ...
  CurrentTimeDisplay.prototype.updateContent = function updateContent() {
    ...
    var frame_rate = this.options_['frame_rate'] || this.options_.playerOptions && this.options_.playerOptions['frame_rate'];
    var formattedTime = secFrameToTimecode (time, frame_rate);
...
var DurationDisplay = (function (_Component) {
  ...
  DurationDisplay.prototype.createEl = function createEl() {
    ...
    this.contentEl_ = Dom.createEl('div', {
      ...
      innerHTML: '<span class="vjs-control-text">' + this.localize('Duration Time') + '</span> 00:00:00:00'
    }, {
      // tell screen readers not to automatically read the time as it changes
      'aria-live': 'off'
    });
  ...
  DurationDisplay.prototype.updateContent = function updateContent() {
    ...
    if (duration && this.duration_ !== duration) {
      ...
      var frame_rate = this.options_['frame_rate'] || this.options_.playerOptions && this.options_.playerOptions['frame_rate'];
      var formattedTime = secFrameToTimecode (duration, frame_rate);
...
var Player = (function (_Component) {
  ...
  Player.prototype.loadTech_ = function loadTech_(techName, source) {
    ...
    var techOptions = _objectAssign2['default']({
      ...
      'update_fps':this.options_.update_fps,
...
var Tech = (function (_Component) {
  ...
  Tech.prototype.trackCurrentTime = function trackCurrentTime() {
    ...
    var intervalfps = this.options_['update_fps'] || 250;

    this.currentTimeInterval = this.setInterval(function () {
      this.trigger({ type: 'timeupdate', target: this, manuallyTriggered: true });   
    }, intervalfps); // 42 = 24 fps, // 250 is what Webkit uses // FF uses 15
  };
