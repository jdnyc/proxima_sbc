(function () {
  ...
  Store = new Ext.extend(Object, {
    ...
    getUserStore: function () {
      return new Ext.data.JsonStore({
        // proxy: makeHttpProxy('GET', '/api/v1/users'),
        proxy: makeHttpProxy('GET', '/api/v1/open/users'),
        root: 'data',
        fields: [
          'user_id', // 사용자 아이디
          'user_nm', // 사용자 명
    ...
    // 사용자ID MASKING 조회
    getMaskingUserStore: function () {
      return new Ext.data.JsonStore({
        proxy: makeHttpProxy('GET', '/api/v1/open/users/masking'),
        root: 'data',
        fields: [
          'member_id',
          'user_id',
