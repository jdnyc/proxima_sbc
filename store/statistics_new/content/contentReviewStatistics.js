(function () {
  ...
  function headerStyle(value, metaData, record) {
    if (record.get('request_date') === 'total') {
  ...
  var store = new Ext.data.JsonStore({
    ...
    proxy: new Ext.data.HttpProxy({
      method: 'GET',
      url: '/api/v1/statistics-content-review',
      type: 'rest'
    }),
    fields: [
      { name: 'request_date'},
  ...
  var grid = new Ext.grid.GridPanel({
    id: gridId,
    title: '<span class="user_span"><span class="icon_title"><i class=""></i></span><span class="main_title_header">' + '콘텐츠 등록 승인 통계' + '</span></span>',
