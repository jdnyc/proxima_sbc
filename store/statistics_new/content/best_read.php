...
$get_datas = $mdb->queryAll("select count(l.action) as value, l.user_id, m.user_nm 
							from bc_log l, bc_member m 
							where l.action = 'read' 
								  and l.user_id = m.user_id 
								  and l.created_date 
								  between $start_date and $end_date group by l.user_id, m.user_nm order by count(l.action) desc");
$i = "1";
