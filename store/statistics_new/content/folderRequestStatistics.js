(function () {
  ...
  function totalColumn(record) {
    ...
    var classifications = ['request', 'approval', 'reject', 'deleted'];
  ...
  var store = new Ext.data.JsonStore({
    ...
    proxy: new Ext.data.HttpProxy({
      method: 'GET',
      url: '/api/v1/statistics-folder-request',
      type: 'rest'
    }),
    fields: [
      { name: 'request_date'},
  ...
  var grid = new Ext.grid.GridPanel({
    id: gridId,
    title: '<span class="user_span"><span class="icon_title"><i class=""></i></span><span class="main_title_header">' + '제작폴더 신청 통계' + '</span></span>',
    ...
    cm: new Ext.grid.ColumnModel({
      ...
      columns: [
        ...
        },
        {
          ...
          width: 100, 
          renderer: function(value, metaData, record) {
            var statusArray = ['request','approval','reject','deleted'];
            var total = 0;
