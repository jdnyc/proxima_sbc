...
$get_datas = $mdb->queryAll("select 
										...
										where 
											l.action = 'login' and l.user_id = m.user_id and l.created_date between $start_date and $end_date group by l.user_id,m.user_nm 
										order by value desc");
if(PEAR::isError($get_datas)){
	echo "Msg:".$get_datas->getMessage()."<br />";
	echo "Query:".$mdb->last_query;
	}
$i = "1";
