...
try {
@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/plugin_register_win_premiere_'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] REQUEST ===> '.print_r($_REQUEST, true)."\r\n", FILE_APPEND);
...
//        $receive = urldecode($receive);
		...
		@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 1 decodeData ===> '.print_r($decodeData, true)."\r\n", FILE_APPEND);
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 2 flag ===> '.$flag.' | '.$channel."\r\n", FILE_APPEND);
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 3 flag ===> '.$flag.' | '.$channel."\r\n", FILE_APPEND);
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 4 flag ===> '.$flag.' | '.$channel."\r\n", FILE_APPEND);
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 5 flag ===> '.$flag.' | '.$channel."\r\n", FILE_APPEND);
...
//            $task_id = '308003';
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 3 response_text ===> '.print_r($response_text, true)."\r\n", FILE_APPEND);
...
function insertContent($metaValues, $content_id, $category_id, $bs_content_id,
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] 3 response_text ===> '.$category_id.' | '.$category_full_path.' | '.$bs_content_id.' | '.$bs_content_id.' | '.$ud_content_id.' | '.$content_id.' | '.$title.' | '.$user_id.' | '.$cur_time.' | '.$cur_time.' | '.$expired_date.' | '.$group_count.' | '.$group_type.' | '.$parent_content_id.' | '.INGEST_READY.' | '.$category_id.' | '.$category_id.' | '."\r\n", FILE_APPEND);
	//$parent_content_id = '1';
...
@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] after insert content ===> '."\r\n", FILE_APPEND);
    $action = 'regist';
...
function insertMediaMetadata($content_id, $type, $filename, $channel) {
    global $db;
@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] before insert media ===> '."\r\n", FILE_APPEND);
	...
	@file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').'] after insert media ===> '."\r\n", FILE_APPEND);
}
...
function  insertMetaValues($metaValues, $content_id, $meta_table_id ,$update = null ) {
    ...
    @file_put_contents($_SERVER['DOCUMENT_ROOT'].'/log/json_register_premiere'.date('Ymd').'.log', $_SERVER['REMOTE_ADDR']."\t[".date('Y-m-d H:i:s').']'.$query."\n", FILE_APPEND);
