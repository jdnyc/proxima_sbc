...
require_once 'SoapGetRestoreList.php';
$server->register('SoapGetRestoreList',
	array(
	),
	array(
			'code' => 'xsd:string',
	...
	$namespace,
	$namespace.'#SoapGetRestoreList',
	'rpc',
	'encoded',
	'SoapGetRestoreList'
);
require_once 'SoapGetNewCartridgeId.php';
...
include_once('SoapGetTaskId.php');
