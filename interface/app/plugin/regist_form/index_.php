...
<meta name="viewport" content="initial-scale=1, maximum-scale=1,user-scalable=no"/>
	...
	* html .x-grid3-body { height: 1%; }
	...
	.x-tool-refresh21 {background-image: url(/css/h_img/win_refresh.png ) !important;repeat-x; width: 20px; height: 20px;margin: 0px 10px 0px 0px;}
	.x-tool-detail2 {background-image: url(/css/h_img/win_list.png) !important;repeat-x; width: 20px; height: 20px;margin: 0px 10px 0px 0px;}
	.x-tool-list2 {background-image: url(/css/h_img/win_look_list.png) !important;repeat-x;width: 20px; height: 20px;margin: 0px 10px 0px 0px;}
	.x-tool-tile2 {background-image: url(/css/h_img/win_look.png) !important;repeat-x;width: 20px; height: 20px;margin: 0px 10px 0px 0px;}
