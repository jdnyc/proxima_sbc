...
try{
    ...
    THUMB_FILE_PATH,
    THUMB_FILE_NM,
    MOBILE_MEDIA_FILE from MIGRATION_CM_CONTENT_MEDIA WHERE REGIST_DT between TO_DATE('20150101000000','YYYYMMDDHH24MISS') AND TO_DATE('20151201000000','YYYYMMDDHH24MISS') order by HMPG_CONTENT_ID asc");
