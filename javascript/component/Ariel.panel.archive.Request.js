...
(function() {
    ...
    Ariel.panel.archive.Request = Ext.extend(Ext.grid.GridPanel, {
        ...
        initComponent: function(config) {
            ...
            Ariel.panel.archive.Request.superclass.initComponent.call(this);

            store.load();
        }
    });

    Ext.reg('panelarchiverequest', Ariel.panel.archive.Request);
})();
