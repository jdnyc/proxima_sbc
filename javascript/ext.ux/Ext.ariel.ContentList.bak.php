...
<tbody>
    <tr>
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'._text('MN02274').'</td>
        <td style=\ "position:relative;\">
            <span class="icon fa-stack " style="position:relative;">
                <i class="fa fa-square fa-stack-1x" style="font-size:17px;left:0px;"></i>
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'._text('MN02275').'</td>
    </tr>
    <tr>
        <td style=\ "position:relative;\">
        <span class="icon fa-stack " style="position:relative;">
                <i class="fa fa-square fa-stack-1x" style="font-size:17px;left:0px;"></i>
                <strong class="fa fa-inverse fa-text fa-stack-1x" style="top:0px;left:0px;font-size:8px;font-weight:bold;">ON</strong>
            </span>
        </td>
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'원본파일 있음'.'</td>
        <td style=\ "position:relative;\">
        <span class="icon fa-stack " style="position:relative;">
                <i class="fa fa-square fa-stack-1x" style="font-size:17px;left:0px;"></i>
                <strong class="fa fa-inverse fa-text fa-stack-1x" style="top:0px;left:0px;font-size:8px;font-weight:bold;">OFF</strong>
            </span>
        </td>
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'원본파일 없음'.'</td>
    </tr>
    <tr>
    <td style=\ "position:relative;\">
    <span class="icon fa-stack " style="position:relative;">
...
<td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'원본파일 아카이브'.'</td>
    <td style=\ "position:relative;\">
        <span class="icon fa-stack " style="position:relative;">
            <i class="fa fa-square fa-stack-1x" style="font-size:17px;left:0px;"></i>
    ...
    <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'원본파일 리스토어'.'</td>
    </tr>
    <tr>
    <td>
        <span>
    ...
    <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'._text('MN02565').'</td>
		<td style=\ "position:relative;\">
            <span class="icon fa-stack " style="position:relative;">
                <i class=" fa fa-square fa-stack-1x" style="font-size:17px;left:0px;"></i>
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'._text('MN02242').'</td>
	</tr>
	<tr>
        <td>
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'등록 완료'.'</td>
        <td>
            <span class="icon fa-stack " style="position:relative;">
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'.'등록 대기'.'</td>
	</tr>
	<tr>
        <td style=\ "position:relative;\">
            <span class="icon fa-stack " style="position:relative;color:green">
        ...
        <td class="textCon" style=\ "padding: 0 0 0 5px;width:230px;\">'._text('MN02368').'</td>
        <td style=\ "position:relative;\">
...
//	enableDragDrop: true,
	...
	sendAction: function(action, records, self) {
        if (action == 'delete' || action == 'delete_hr') {
			...
			listeners: {
				afterrender: function(self){
					...
					self.add({
						...
						width: 30,
						cls: 'proxima_btn_customize proxima_btn_customize_new proxima_btn_control_tool',
						text: '<i class="fa fa-align-justify" aria-hidden="true" title="'+_text('MN00062')+'"></i>',
						handler: function(self){
                            var active_tab_id = Ext.getCmp('tab_warp').getActiveTab().id;
                            var last_child = $("div#"+active_tab_id).find("div.cls_slider").find("tr.x-toolbar-right-row").last();
                            var cls_last_child = last_child.find("td.x-toolbar-cell").find("table.x-btn.proxima_btn_customize").removeClass("cls_action");
