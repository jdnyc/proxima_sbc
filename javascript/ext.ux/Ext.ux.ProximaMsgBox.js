			...
			return {
				...
				getDialog : function(titleText){
				   if(!dlg){
						...
						dlg.getEl().addClass('proxima-x-window-dlg');
						mask = dlg.mask;
						bodyEl = dlg.body.createChild({
							html:'<div class="ext-mb-icon" style="display:none"></div><div class="ext-mb-content" style="position:relative;padding:10px;"><span class="ext-mb-text" style=""></span><br /><div class="ext-mb-fix-cursor"><input type="text" class="ext-mb-input" /><textarea class="ext-mb-textarea"></textarea></div></div>'
						});
				...
				updateText : function(text){
					...
					//Proxima 부분 padding 처리로 10px 더 넓혀줌
					w+=24;
				...
				show : function(options){
					...
					if(!d.isVisible()){
						...
						d.setAnimateTarget(Ext.isEmpty(opt.animEl) ? d.setAnimateTarget : opt.animEl);
						...
						d.show(Ext.isEmpty(opt.animEl) ? d.setAnimateTarget : opt.animEl);
					}
					if(opt.wait === true){
