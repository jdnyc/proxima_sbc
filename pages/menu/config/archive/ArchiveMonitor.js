	...
	Ariel.monitor.TaskPanel = Ext.extend(Ext.grid.GridPanel, {
		...
		initComponent: function(){
			...
			this.store = new Ext.data.JsonStore({
				url: '/store/get_archive_task.php',
				totalProperty: 'total',
				idProperty: 'task_id',
				root: 'data',
				fields: [
			...
			Ext.apply(this, {
				...
				columns: [
					...
					{header: 'Type', dataIndex: 'type', width: 80, align: 'center', renderer : renderTaskType},
					...
					{header: _text('MN00120'), dataIndex: 'task_user_id', width: 60},
					{header: _text('MN00249'), dataIndex: 'title', width: 150},
					...
					{header: _text('MN00138'), dataIndex: 'status', align: 'center', width: 70, renderer: renderTaskMonitorStatus},
	...
	return {
		...
		items: [{
			...
			items: [{
				title: '전체',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 'all'})
			},{
				//>>title: '카탈로깅',
				title: '뉴스편집영상',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 334})
			},{
				title: 'News(HD)',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 374})
			},{
				title: 'News(SD)',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 202})
			},{
				title: '외신영상',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 394})
			},{
				title: 'INGEST',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 314})
			},{
				title: '제작NPS',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 358})
			},{
				title: 'NPS TAPE',
				layout: 'fit',
				items: new Ariel.monitor.TaskPanel({ud_content_id: 397})
			}]
		}]
	}
})()