(function () {
  ...
  let pageNm = '유형별';
  let statisticsTypeValue = 'content_type';
  let excelFileNameValue = '콘텐츠입수_유형별_통계';
  ...
  function totalColumn(record) {
    ...
    var classifications = ['origin', 'clean', 'master', 'audio', 'image', 'clip', 'cg', 'news'];
  ...
  var store = new Ext.data.JsonStore({
    ...
    proxy: new Ext.data.HttpProxy({
      method: 'GET',
      url: '/api/v1/statistics-content-type',
      type: 'rest'
    }),
    fields: [
      'dt',
