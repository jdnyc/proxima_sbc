(function () {
  ...
  let excelFileNameValue = '콘텐츠 아카이브 삭제 통계';
  ...
  var grid = new Ext.grid.GridPanel({
    id: gridId,
    title: '<span class="user_span"><span class="icon_title"><i class=""></i></span><span class="main_title_header">' + '아카이브 삭제' + '</span></span>',
