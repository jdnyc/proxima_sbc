...
function fn_install_schema_and_data_oracle($data){
	...
	$all_query_otr = '	
		...
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (62,\'CONTENT_STATUS\',\'콘텐츠상태\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (238,\'CONTENT_STATUS_ENG\',\'Content status\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (132,\'ED_to_tapeless\',\'EDIUS에서 종편 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (170,\'FCP_to_subcontrol\',\'FCP에서 부조 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (130,\'FCP_to_tapeless\',\'FCP에서 종편 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (4,\'FLDDDT\',\'파일별 삭제기한\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (5,\'FLDLNM\',\'삭제기한 콘텐츠파일종류\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (91,\'MEDCD\',\'매체코드\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (90,\'NPS_WORK\',\'제작정보\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (150,\'NPS_to_subcontrol\',\'NPS에서 부조 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (131,\'NPS_to_tapeless\',\'NPS에서 종편 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (233,\'QUOTA_LIMIT\',\'쿼터 알림 설정값\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (241,\'REVIEW_STATUS\',\'심의 상태\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (190,\'SCTL_to_NPS\',\'부조에서 NPS 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (243,\'SOLR_USEABLE\',\'검색엔진 사용여부\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (230,\'STORAGE_ROOT\',\'스토리지 루트\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (210,\'TAPEL_to_NPS\',\'종편에서 NPS 전송\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (231,\'TASK_STATUS\',\'작업상태\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (236,\'TEST\',\'테스트\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (3,\'UCDDDT\',\'콘텐츠 별 삭제기한\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (2,\'UCSDDT\',\'사용자콘텐츠 삭제기한\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (171,\'XDS_IP_CHANNEL\',\'XDS 서버 정보\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (1,\'content_grant\',\'콘텐츠 권한\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (244,\'grant_content\',\'콘텐츠 접근 권한\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (21,\'ingest_ip\',\'인제스트 서버\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (42,\'main_summary_field\',\'메인 그리드 섬네일,요약보기 대상 필드 코드\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (237,\'main_summary_field_eng\',\'메인 그리드 미리보기, 요약보기 대상 필드 코드 영문\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (232,\'npstodas_fieldcode_map\',\'NPS와DAS 필드코드매핑\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (83,\'sgl_active_check\',\'SGL ACTIVE CHECK\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (82,\'sgl_group_list\',\'SGL Group\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (110,\'storage_group\',\'스토리지 그룹\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (41,\'testingest\',\'192.168.3.151\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (234,\'ud_content_tab\',\'사용자 정의 콘텐츠 세부구분\');
		Insert into BC_CODE_TYPE (ID,CODE,NAME) values (235,\'ㄴㅇ\',\'ㄴㅇㄹ\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (418,\'1\',\'Thumbnail View\',237,null,0,\'(en)Thumbnail View\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (421,\'-2\',\'(E)등록중\',238,null,0,\'(en)(E)등록중\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (428,\'4\',\'(E)심의승인\',238,null,0,\'(en)(E)심의승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (430,\'6\',\'(E)심의조건부승인\',238,null,0,\'(en)(E)심의조건부승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (443,\'3\',\'심의대기\',241,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (445,\'5\',\'심의반려\',241,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (446,\'6\',\'심의조건부승인\',241,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (374,\'88\',\'스토리지 ID\',230,null,0,\'(en)스토리지 ID\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (378,\'error\',\'실패\',231,null,0,\'(en)실패\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (380,\'canceled\',\'작업취소\',231,null,0,\'(en)작업취소\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (386,\'usr_materialid\',\'mtrl_id\',232,null,0,\'(en)mtrl_id\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (387,\'usr_progid\',\'pgm_id\',232,null,0,\'(en)pgm_id\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (388,\'usr_turn\',\'epsd_id\',232,null,0,\'(en)epsd_id\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (389,\'usr_program\',\'pgm_nm\',232,null,0,\'(en)pgm_nm\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (391,\'ori_path\',\'path\',232,null,0,\'(en)path\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (383,\'transfer\',\'전송\',90,null,0,\'(en)전송\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (390,\'10\',\'쿼터 알림 제한값\',233,null,0,\'(en)쿼터 알림 제한값\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (173,\'2\',\'AD\',110,null,0,\'(en)AD\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (61,\'1\',\'미리 보기\',42,null,0,\'Thumbnail View\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (62,\'2\',\'요약 보기\',42,null,0,\'Summary view\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (84,\'3\',\'심의대기\',62,null,0,\'(en)심의대기\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (88,\'-5\',\'반려\',62,null,0,\'(en)반려\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (42,\'30\',\'30일\',3,null,0,\'(en)30일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (45,\'192.168.3.151\',\'인제스트1\',21,null,0,\'(en)인제스트1\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (41,\'30\',\'30일\',2,null,0,\'(en)30일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (44,\'30\',\'30일\',4,null,0,\'(en)30일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (20,\'pfr\',\'구간추출파일\',5,null,0,\'(en)구간추출파일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (19,\'original\',\'원본파일\',5,null,0,\'(en)원본파일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (47,\'60\',\'60일\',3,null,0,\'(en)60일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (15,\'-1\',\'영구보존\',2,null,0,\'(en)영구보존\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (17,\'-1\',\'영구보존\',3,null,0,\'(en)영구보존\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (18,\'-1\',\'영구보존\',4,null,0,\'(en)영구보존\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (21,\'capture\',\'캡쳐이미지파일\',5,null,0,\'(en)캡쳐이미지파일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (48,\'60\',\'60일\',4,null,0,\'(en)60일\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (81,\'0\',\'대기\',62,null,0,\'(en)대기\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (82,\'2\',\'승인\',62,null,0,\'(en)승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (83,\'-2\',\'등록중\',62,null,0,\'(en)등록중\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (85,\'4\',\'심의승인\',62,null,0,\'(en)심의승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (86,\'5\',\'심의반려\',62,null,0,\'(en)심의반려\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (87,\'6\',\'심의조건부승인\',62,null,0,\'(en)심의조건부승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (89,\'-6\',\'재승인요청\',62,null,0,\'(en)재승인요청\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (132,\'-7\',\'삭제요청\',62,null,0,\'(en)삭제요청\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (92,\'info\',\'제작정보\',90,null,0,\'(en)제작정보\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (130,\'archive\',\'아카이브\',90,null,0,\'(en)아카이브\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (90,\'preview\',\'프리뷰노트\',90,null,0,\'(en)프리뷰노트\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (91,\'review\',\'심의\',90,null,0,\'(en)심의\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (375,\'queue\',\'작업대기\',231,null,0,\'(en)작업대기\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (376,\'processing\',\'작업중\',231,null,0,\'(en)작업중\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (377,\'complete\',\'작업성공\',231,null,0,\'(en)작업성공\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (379,\'assigning\',\'작업할당중\',231,null,0,\'(en)작업할당중\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (381,\'pending\',\'작업대기중\',231,null,0,\'(en)작업대기중\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (382,\'regist\',\'등록\',90,null,0,\'(en)등록\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (392,\'program\',\'프로그램\',234,null,0,\'(en)프로그램\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (393,\'topic\',\'토픽\',234,null,0,\'(en)토픽\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (415,\'4\',\'상세 보기\',42,null,0,\'List View\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (417,\'ㄴㅇㄹ\',\'ㄴㅇㄹ\',235,null,0,\'(en)ㄴㅇㄹ\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (416,\'TEST\',\'테스트\',236,null,0,\'(en)테스트\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (420,\'4\',\'List View\',237,null,0,\'(en)List View\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (444,\'4\',\'심의승인\',241,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (419,\'2\',\'Summary View\',237,null,0,\'(en)Summary View\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (119,\'N\',\'Active Code\',83,null,0,\'(en)Active Code\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (423,\'-6\',\'(E)재승인요청\',238,null,0,\'(en)(E)재승인요청\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (424,\'-7\',\'(E)삭제요청\',238,null,0,\'(en)(E)삭제요청\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (425,\'0\',\'(E)대기\',238,null,0,\'(en)(E)대기\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (426,\'2\',\'(E)승인\',238,null,0,\'(en)(E)승인\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (427,\'3\',\'(E)심의대기\',238,null,0,\'(en)(E)심의대기\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (429,\'5\',\'(E)심의반려\',238,null,0,\'(en)(E)심의반려\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (448,\'SGLDSK2\',\'SGLDSK2\',82,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (447,\'SGLDSK1\',\'SGLDSK1\',82,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (451,\'0\',\'1: 사용 0:미사용\',243,null,0,null);
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (463,\'1\',\'읽기\',244,null,0,\'Read\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (464,\'2\',\'수정\',244,null,0,\'Edit\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (465,\'4\',\'등록\',244,null,0,\'Register\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (466,\'8\',\'다운로드\',244,null,0,\'Download\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (467,\'16\',\'카테고리 수정\',244,null,0,\'Category Manage\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (468,\'1\',\'작업흐름보기\',1,null,0,\'Show Workflow\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (469,\'2\',\'관심콘텐츠\',1,null,0,\'Favorate\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (470,\'4\',\'삭제\',1,null,0,\'Delete\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (471,\'8\',\'아카이브\',1,null,0,\'Archive\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (472,\'16\',\'리스토어\',1,null,0,\'Restore\');
		Insert into BC_CODE (ID,CODE,NAME,CODE_TYPE_ID,SORT,HIDDEN,ENAME) values (422,\'-5\',\'(E)반려\',238,null,0,\'(en)(E)반려\');
		...
		Insert into BC_SYS_CODE (ID,CODE,CODE_NM,TYPE_ID,SORT,USE_YN,MEMO,REF1,REF2,REF3,REF4,REF5,CREATED_DATE,CREATED_USER,UPDATED_DATE,UPDATED_USER) values (5,\'HRDK_BUILDGRIDMENU_ORIGINAL\',\'한국산업인력공단\',1,1,\'N\',null,null,null,null,null,null,\'20150713000000\',0,\'20150713000000\',0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (1,2,3,5,\'null\',3,null,105,105,null,0);
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (4,11,3,17,\'null\',10,null,105,105,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (8,14,3,25,\'null\',13,null,105,105,null,24);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (9,18,3,29,\'null\',17,null,105,105,null,28);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (10,21,2,32,\'null\',20,null,104,105,null,31);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (12,26,1,37,\'null\',0,null,106,104,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (2,2,3,8,\'null\',3,null,105,105,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (3,7,2,11,\'null\',5,null,104,105,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (5,5,1,14,\'null\',0,null,106,104,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (6,1,3,20,\'null\',3,null,105,105,null,0);
		...
		Insert into BC_TASK_WORKFLOW_RULE (TASK_WORKFLOW_ID,TASK_RULE_ID,JOB_PRIORITY,WORKFLOW_RULE_ID,CONDITION,TASK_RULE_PARANT_ID,CONTENT_STATUS,SOURCE_PATH_ID,TARGET_PATH_ID,STORAGE_GROUP,WORKFLOW_RULE_PARENT_ID) values (11,25,3,36,\'null\',24,null,105,105,null,35);
